...
\begin{figure}[H]
\subfloat[Long d'un call]{\includegraphics[scale=0.65]{figures/Long_d'un_call.png}}
\subfloat[Short d'un call]{\includegraphics[scale=0.65]{figures/Short_d'un_call.png}} \\
\subfloat[Long d'un put]{\includegraphics[scale=0.65]{figures/Long_d'un_put.png}}
\subfloat[Short d'un put]{\includegraphics[scale=0.65]{figures/Short_d'un_put.png}}
...
\end{align*}
\begin{figure}[H]
\subfloat[call tetha]{\includegraphics[scale=0.3]{figures/theta.png}}
\subfloat[put theta]{\includegraphics[scale=0.3]{figures/put_theta.png}} \\
...
\begin{figure}[H]
\subfloat[call rho]{\includegraphics[scale=0.3]{figures/put_rho.png}}
\subfloat[put rho]{\includegraphics[scale=0.3]{figures/call_rho.png}} 
